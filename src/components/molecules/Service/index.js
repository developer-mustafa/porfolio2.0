  ...
  const services = [
    {
      ...
      icon: <FiServer />,
      description:
        "As a Full stack developer, I would love to develope any full stack application using React and its libraries with ExpressJS ,NodeJS,MongoDB.or NextJs with Prisma",
    },
    {
      id: 1,
      ...
      icon: <DiAtom />,
      description:
        "As a Front-end developer, I would love to develope any front-end application using React and its libraries.Or NextJS",
    },

    {
      ...
      icon: <FiServer />,
      description:
        "As a Back-end developer, I would love to develope any Back-end application Or developed Back end API / Restful API  using ExpressJS for Database MongoDB ,MVC Architectural Backend Development with Mongoose (Schema, Model etc) to manage the server easily.",
     },
      {
      id: 3,
...

    {
      ...
      icon: <BiPalette />,
      description:
        "I also provide Fully Responsive Dynamic Website with wordpress Technology .",
    },
    // {
    //   id: 4,
