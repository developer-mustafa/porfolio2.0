...
import { BottomLine, Education, MySkill } from "../../components";
import "../../components/atoms/PrimaryBtn/PrimaryBtn.css";
import "../shared/Shared.css";
import "./About.css";

import profile from  "../../assets/mustafa1.png"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            ...
            <p className="text-neutral font-medium text-center translate-y-[-100%] sm:translate-y-[-0%] sm:mb-2 md:text-left">
              As a MERN stack developer also nextJS with Prisma Developer, I am committed to building high-quality
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Mustafa Rahman
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>+8801840643946
                
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary ">Email : </span>
                mustafa.rahman.official@gmail.com
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>Mirsarai,chattogram,Bangladesh
              </h2>
              <a href="https://mustafa-portfolio1.netlify.app/" target="blank">
